...
const MorphingTrigger = () => {
  return (
    <div className="stroke-palm_green-900 hover:bg-palm_green-100 hover:bg-opacity-1 active:bg-grey-5 active:text-palm_green-900 focus:border-violet-60 disabled:text-grey-30 bg-transparent disabled:bg-transparent rounded-rounded group relative p-[6px]">
