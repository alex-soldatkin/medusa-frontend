...
const DiscountCode: React.FC<DiscountCodeProps> = ({ cart }) => {
  ...
  const appliedDiscount = useMemo(() => {
    ...
    switch (discounts[0].rule.type) {
      ...
      default:
        return "Бесплатная доставка по Митино"
    }
  }, [discounts, region])
          ...
          <div className="flex flex-col mb-4">
            ...
            {gift_cards?.map((gc) => (
              ...
              >
                ...
                >
                  <Trash size={14} />
                  <span className="sr-only">Убрать подарочную карту из заказа</span>
                </button>
              </div>
            ))}
          </div>
        ...
        {appliedDiscount ? (
          <div className="w-full flex items-center">
            <div className="flex flex-col w-full">
              <Heading className="txt-medium">Применена скидка:</Heading>
              <div
              ...
              >
                ...
                >
                  ...
                  <span className="sr-only">
                    ...
                    Убрать скидочный купон из заказа  
                  </span>
                </button>
              </div>
            </div>
          ...
          <form action={formAction} className="w-full">
            <Label className="flex gap-x-1 my-2 items-center">
              ...
              >
                ...
                Добавить подарочную карту или скидочный купон
              </button>
            ...
            {isOpen && (
              <>
                <div className="flex w-full gap-x-2 items-center">
                  <Input
                    label="Введите код купона или подарочной карты..."
                    name="code"
                    type="text"
                    autoFocus={false}
